...
extern "C" {
    ...
    // Summary; Gets the Pointer of DoublelineMode
    // Remarks; This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.
    const char* ANSICodeLists_DoublelineMode();
    
    // Summary; Gets the length of DoublelineMode
    // Remarks; This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.
    int ANSICodeLists_DoublelineMode_Length();
    
    // Summary; Frees the memory of DoublelineMode
    // Remarks; This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.
    void ANSICodeLists_DoublelineMode_Free();
    
    // Summary; Restores the memory of DoublelineMode
    // Remarks; This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.
    void ANSICodeLists_DoublelineMode_Restore();
    
    // Summary; Checks if the memory of DoublelineMode is valid for usage
    // Returns; A true if the memory in the string is valid for use, otherwise false.
    // Remarks; This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.
    bool ANSICodeLists_DoublelineMode_IsMemoryValid();
