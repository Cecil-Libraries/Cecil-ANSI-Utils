...
extern "C" {
    ...
    // Remarks; This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.
    const char* ANSICodeLists_HighIntensityBoldColorList_GetColorByEnum(Color color);
    ...
    // Summary; Checks if the memory in the HighIntensityBoldColorList is valid for usage.
    // Returns; A true if the memory in the list is valid for use, otherwise false.
    // Remarks; This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.
    bool ANSICodeLists_HighIntensityBoldColorList_IsMemoryValid();
