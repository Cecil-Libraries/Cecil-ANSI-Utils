...
{
	public class HighIntensityColorListWrapper
	{
		/// <summary>
        /// The Pointer variant of ANSICodeLists.HighIntensityColorList
        /// </summary>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        internal static readonly IntPtr[] ColorListPointers = ListUtils.InitializeList(ANSICodeLists.HighIntensityColorList);
        ...
        public static int GetHighIntensityColorListCount() => ListUtils.GetListCount(ColorListPointers);
        ...
        public static IntPtr GetHighIntensityColor(int index) => ListUtils.GetItem(ColorListPointers, index);
        ...
        /// <returns>The Color at the given index, if the index is out of bound we return IntPtr.Zero.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_HighIntensityColorList_GetColorByEnum")]
        ...
        public static int FindHighIntensityColorIndex(IntPtr color) => ListUtils.GetItemIndex(ColorListPointers, color);
        ...
        public static void RestoreColorListPointersMemory() => ListUtils.RestoreMemorySingular(ColorListPointers, ANSICodeLists.HighIntensityColorList);
        
        /// <summary>
        /// Checks if the memory in the HighIntensityColorList is valid for usage
        /// </summary>
        /// <returns>A true if the memory in the list is valid for use, otherwise false.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_HighIntensityColorList_IsMemoryValid")]
        public static bool IsHighIntensityColorListPointersMemoryValid() => ColorListPointers.All(p => p != IntPtr.Zero);
	}
}
#endif