...
{
	public class HighlighterColorListWrapper
	{
		/// <summary>
        /// The Pointer variant of ANSICodeLists.HighlighterColorList
        /// </summary>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        internal static readonly IntPtr[] ColorListPointers = ListUtils.InitializeList(ANSICodeLists.HighlighterColorList);
        ...
        public static int GetHighlighterColorListCount() => ListUtils.GetListCount(ColorListPointers);
        ...
        public static IntPtr GetHighlighterColor(int index) => ListUtils.GetItem(ColorListPointers, index);
        ...
        /// <returns>The Color at the given index, if the index is out of bound we return IntPtr.Zero.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_HighlighterColorList_GetColorByEnum")]
        ...
        public static int FindHighlighterColorIndex(IntPtr color) => ListUtils.GetItemIndex(ColorListPointers, color);
        ...
        public static void RestoreColorListPointersMemory() => ListUtils.RestoreMemorySingular(ColorListPointers, ANSICodeLists.HighlighterColorList);
        
        /// <summary>
        /// Checks if the memory in the HighlighterColorList is valid for usage
        /// </summary>
        /// <returns>A true if the memory in the list is valid for use, otherwise false.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_HighlighterColorList_IsMemoryValid")]
        public static bool IsHighlighterColorListPointersMemoryValid() => ColorListPointers.All(p => p != IntPtr.Zero);
	}
}
#endif