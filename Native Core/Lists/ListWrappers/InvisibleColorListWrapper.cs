...
{
	public class InvisibleColorListWrapper
	{
		/// <summary>
        /// The Pointer variant of ANSICodeLists.InvisibleColorList
        /// </summary>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        internal static readonly IntPtr[] ColorListPointers = ListUtils.InitializeList(ANSICodeLists.InvisibleColorList);
        ...
        public static int GetInvisibleColorListCount() => ListUtils.GetListCount(ColorListPointers);
        ...
        public static IntPtr GetInvisibleColor(int index) => ListUtils.GetItem(ColorListPointers, index);
        ...
        /// <returns>The Color at the given index, if the index is out of bound we return IntPtr.Zero.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_InvisibleColorList_GetColorByEnum")]
        ...
        public static int FindInvisibleColorIndex(IntPtr color) => ListUtils.GetItemIndex(ColorListPointers, color);
        ...
        public static void RestoreColorListPointersMemory() => ListUtils.RestoreMemorySingular(ColorListPointers, ANSICodeLists.InvisibleColorList);
        
        /// <summary>
        /// Checks if the memory in the InvisibleColorList is valid for usage
        /// </summary>
        /// <returns>A true if the memory in the list is valid for use, otherwise false.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_InvisibleColorList_IsMemoryValid")]
        public static bool IsInvisibleColorListPointersMemoryValid() => ColorListPointers.All(p => p != IntPtr.Zero);
	}
}
#endif