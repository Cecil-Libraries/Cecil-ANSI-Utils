...
{
	public class HighIntensityInvisibleColorListWrapper
	{
		/// <summary>
        /// The Pointer variant of ANSICodeLists.HighIntensityInvisibleColorList
        /// </summary>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        internal static readonly IntPtr[] ColorListPointers = ListUtils.InitializeList(ANSICodeLists.HighIntensityInvisibleColorList);
        ...
        public static int GetHighIntensityInvisibleColorListCount() => ListUtils.GetListCount(ColorListPointers);
        ...
        public static IntPtr GetHighIntensityInvisibleColor(int index) => ListUtils.GetItem(ColorListPointers, index);
        ...
        /// <returns>The Color at the given index, if the index is out of bound we return IntPtr.Zero.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_HighIntensityInvisibleColorList_GetColorByEnum")]
        ...
        public static int FindHighIntensityInvisibleColorIndex(IntPtr color) => ListUtils.GetItemIndex(ColorListPointers, color);
        ...
        public static void RestoreColorListPointersMemory() => ListUtils.RestoreMemorySingular(ColorListPointers, ANSICodeLists.HighIntensityInvisibleColorList);
        
        /// <summary>
        /// Checks if the memory in the HighIntensityInvisibleColorList is valid for usage
        /// </summary>
        /// <returns>A true if the memory in the list is valid for use, otherwise false.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_HighIntensityInvisibleColorList_IsMemoryValid")]
