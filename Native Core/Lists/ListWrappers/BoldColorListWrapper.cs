...
{
	public class BoldColorListWrapper
	{
		/// <summary>
        ...
        public static int GetBoldColorListCount() => ListUtils.GetListCount(ColorListPointers);
        ...
        public static IntPtr GetBoldColor(int index) => ListUtils.GetItem(ColorListPointers, index);
        ...
        /// <returns>The Color at the given index, if the index is out of bound we return IntPtr.Zero.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_BoldColorList_GetColorByEnum")]
        ...
        public static int FindBoldColorIndex(IntPtr color) => ListUtils.GetItemIndex(ColorListPointers, color);
        ...
        public static void RestoreColorListPointersMemory() => ListUtils.RestoreMemorySingular(ColorListPointers, ANSICodeLists.BoldColorList);
        
        /// <summary>
        /// Checks if the memory in the BoldColorList is valid for usage
        /// </summary>
        /// <returns>A true if the memory in the list is valid for use, otherwise false.</returns>
        /// <remarks>This code is provided by Creator/Chaosyr/SaxbyMod/The Stoat Lord.</remarks>
        [UnmanagedCallersOnly(EntryPoint = "ANSICodeLists_BoldColorList_IsMemoryValid")]
        public static bool IsBoldColorListPointersMemoryValid() => ColorListPointers.All(p => p != IntPtr.Zero);
	}
}
#endif